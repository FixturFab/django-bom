    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True,
                                   choices=[('', '-----'), ('A', 'A'), ('uA', 'μV'), ('mA', 'mA'), ('kA', 'kA'),
                                            ('MA', 'MA'), ('Other', 'Other')], default=None, max_length=2, null=True),
        ),
        migrations.AddField(
            model_name='partrevision',
            name='finish',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True,
                                   choices=[('', '-----'), ('Hz', 'Hz'), ('kHz', 'kHz'), ('MHz', 'MHz'), ('GHz', 'GHz'),
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True,
                                   choices=[('', '-----'), ('mil', 'mil'), ('in', 'in'), ('ft', 'ft'), ('yd', 'yd'),
                                            ('km', 'km'), ('m', 'm'), ('cm', 'cm'), ('um', 'um'), ('nm', 'nm'),
                                            ('Other', 'Other')], default=None, max_length=5, null=True),
        ),
        migrations.AddField(
            model_name='partrevision',
            name='interface',
            field=models.CharField(blank=True, choices=[('', '-----'), ('I2C', 'I2C'), ('SPI', 'SPI'), ('CAN', 'CAN'),
                                                        ('One-Wire', '1-Wire'), ('RS485', 'RS-485'),
                                                        ('RS232', 'RS-232'), ('WiFi', 'Wi-Fi'), ('4G', '4G'),
                                                        ('BT', 'Bluetooth'), ('BTLE', 'Bluetooth LE'),
                                                        ('Z_Wave', 'Z-Wave'), ('Zigbee', 'Zigbee'), ('LAN', 'LAN'),
                                                        ('USB', 'USB'), ('HDMI', 'HDMI'), ('Other', 'Other')],
                                   default=None, max_length=12, null=True),
        ),
        migrations.AddField(
            model_name='partrevision',
            name='length',
        ...
        migrations.AddField(
            ...
            name='package',
            field=models.CharField(blank=True,
                                   choices=[('', '-----'), ('0201 smd', '0201 smd'), ('0402 smd', '0402 smd'),
                                            ('0603 smd', '0603 smd'), ('0805 smd', '0805 smd'),
                                            ('1206 smd', '1206 smd'), ('1210 smd', '1210 smd'),
                                            ('1812 smd', '1812 smd'), ('2010 smd', '2010 smd'),
                                            ('2512 smd', '2512 smd'), ('1/8 radial', '1/8 radial'),
                                            ('1/4 radial', '1/4 radial'), ('1/2 radial', '1/2 radial'),
                                            ('Size A', 'Size A'), ('Size B', 'Size B'), ('Size C', 'Size C'),
                                            ('Size D', 'Size D'), ('Size E', 'Size E'), ('SOT-23', 'SOT-23'),
                                            ('SOT-223', 'SOT-233'), ('DIL', 'DIL'), ('SOP', 'SOP'), ('SOIC', 'SOIC'),
                                            ('QFN', 'QFN'), ('QFP', 'QFP'), ('QFT', 'QFT'), ('PLCCP', 'PLCC'),
                                            ('VGA', 'VGA'), ('Other', 'Other')], default=None, max_length=16,
                                   null=True),
        ),
        migrations.AddField(
            model_name='partrevision',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True,
                                   choices=[('', '-----'), ('W', 'W'), ('uW', 'μW'), ('mW', 'mW'), ('kW', 'kW'),
                                            ('MW', 'MW'), ('Other', 'Other')], default=None, max_length=5, null=True),
        ),
        migrations.AddField(
            model_name='partrevision',
            name='supply_voltage',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True,
                                   choices=[('', '-----'), ('V', 'V'), ('uV', 'μV'), ('mV', 'mV'), ('kV', 'kV'),
                                            ('MV', 'MV'), ('Other', 'Other')], default=None, max_length=5, null=True),
        ),
        migrations.AddField(
            model_name='partrevision',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, choices=[('', '-----'), ('C', '°C'), ('F', '°F'), ('Other', 'Other')],
        ...
        migrations.AddField(
            ...
            name='value_units',
            field=models.CharField(blank=True,
                                   choices=[('', '-----'), ('Ohms', 'Ω'), ('mOhms', 'mΩ'), ('kOhms', 'kΩ'), ('F', 'F'),
                                            ('pF', 'pF'), ('nF', 'nF'), ('uF', 'μF'), ('V', 'V'), ('uV', 'μV'),
                                            ('mV', 'mV'), ('A', 'A'), ('uA', 'μA'), ('mA', 'mA'), ('C', '°C'),
                                            ('F', '°F'), ('Other', 'Other')], default=None, max_length=5, null=True),
        ),
        migrations.AddField(
            model_name='partrevision',
            name='voltage_rating',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True,
                                   choices=[('', '-----'), ('V', 'V'), ('uV', 'μV'), ('mV', 'mV'), ('kV', 'kV'),
                                            ('MV', 'MV'), ('Other', 'Other')], default=None, max_length=2, null=True),
        ),
        migrations.AddField(
            model_name='partrevision',
            name='wavelength',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True,
                                   choices=[('', '-----'), ('km', 'km'), ('m', 'm'), ('cm', 'cm'), ('um', 'μm'),
                                            ('nm', 'nm'), ('A', 'A'), ('Other', 'Other')], default=None, max_length=5,
                                   null=True),
        ),
        migrations.AddField(
            model_name='partrevision',
        ...
        migrations.AddField(
            ...
            name='weight_units',
            field=models.CharField(blank=True,
                                   choices=[('', '-----'), ('mg', 'mg'), ('g', 'g'), ('kg', 'kg'), ('oz', 'oz'),
                                            ('lb', 'lb'), ('Other', 'Other')], default=None, max_length=5, null=True),
        ),
        migrations.AddField(
            model_name='partrevision',
            name='width',
        ...
        migrations.AlterField(
            model_name='part',
            name='number_item',
            field=models.CharField(blank=True, default=None, max_length=10, validators=[
